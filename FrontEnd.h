...
#include "ZShadeSandboxEditorPicker.h"
...
#pragma endregion
	...
	{
		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxEditor2D = (gcnew ZShadeSandbox::ZShadeSandboxEditor2D(mZShadeFrontEnd->GetEngineOptions()));
		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxEditor2D->ClientSize = System::Drawing::Size(mZShadeFrontEnd->GetEngineOptions()->m_screenWidth, mZShadeFrontEnd->GetEngineOptions()->m_screenHeight);
		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxEditor2D->Init();

		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxEditor3D = (gcnew ZShadeSandbox::ZShadeSandboxEditor3D(mZShadeFrontEnd->GetEngineOptions()));
		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxEditor3D->ClientSize = System::Drawing::Size(mZShadeFrontEnd->GetEngineOptions()->m_screenWidth, mZShadeFrontEnd->GetEngineOptions()->m_screenHeight);
		////ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxEditor2D->Init();

		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxInventoryEditor = (gcnew ZShadeSandbox::ZShadeSandboxInventoryEditor(mZShadeFrontEnd->GetEngineOptions()));
		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxInventoryEditor->ClientSize = System::Drawing::Size(mZShadeFrontEnd->GetEngineOptions()->m_screenWidth, mZShadeFrontEnd->GetEngineOptions()->m_screenHeight);
		////ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxInventoryEditor->Init();

		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxMenuEditor = (gcnew ZShadeSandbox::ZShadeSandboxMenuEditor(mZShadeFrontEnd->GetEngineOptions()));
		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxMenuEditor->ClientSize = System::Drawing::Size(mZShadeFrontEnd->GetEngineOptions()->m_screenWidth, mZShadeFrontEnd->GetEngineOptions()->m_screenHeight);
		////ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxMenuEditor->Init();

		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxHUDEditor = (gcnew ZShadeSandbox::ZShadeSandboxHUDEditor(mZShadeFrontEnd->GetEngineOptions()));
		//ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxHUDEditor->ClientSize = System::Drawing::Size(mZShadeFrontEnd->GetEngineOptions()->m_screenWidth, mZShadeFrontEnd->GetEngineOptions()->m_screenHeight);
		////ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->zShadeSandboxHUDEditor->Init();
	}
	private: System::Void EditorModeButton_Click(System::Object^  sender, System::EventArgs^  e)
	{
		mZShadeFrontEnd->SetInEditor(true);
		ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->engineOptions = mZShadeFrontEnd->GetEngineOptions();
		ZShadeSandbox::ZShadeSandboxEditorHelper::Instance->InitEditorWindows();
		ZShadeSandboxEditorPicker^ form = gcnew ZShadeSandboxEditorPicker(mZShadeFrontEnd->GetEngineOptions());
		form->Show();

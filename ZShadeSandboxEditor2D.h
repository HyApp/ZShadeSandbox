...
// Maybe each editor window can have its own splitter container and dx window, so
// that they can each have a separate tool window.
...
namespace ZShadeSandbox {
	...
	public:
		...
		void Run()
		{
			//bool iniContainsGameFolder;
			//bool initLoadCache;
			//ZShadeSandbox::Instance()->RunDXWindowInThread(iniContainsGameFolder, initLoadCache);
			// Need to redesign this since these lines will never get called and this should be assign before the while loop
			//bINIContainsGameFolder = iniContainsGameFolder;
			//bInitLoadCache = initLoadCache;
		...
		*/
		...
		void SetSpriteTabDefaults()
		{
			...
			CheckRepositionAndResizeOfSpriteTab();
		}
		...
		System::Void TileCachePictureBox_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e)
		{
			for (int i = 0; i < mTileCacheImages->Length; i++)
			{
				if (mTileCacheImages[i] == sender)
				{
					...
					mEditorHelper2D->GetMapEditorSystem2D()->SelectedTileName() =
						ZShadeSandbox::ConvertToStandardString(m_SelectedTileImage);
		...
		System::Void SpriteCachePictureBox_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e)
		{
			for (int i = 0; i < mSpriteCacheImages->Length; i++)
			{
				if (mSpriteCacheImages[i] == sender)
				{
					...
					// Add the selected image name to the map editor system
					mEditorHelper2D->GetMapEditorSystem2D()->SelectedSpriteName() =
						ZShadeSandbox::ConvertToStandardString(m_SelectedSpriteImage);
		...
		void SetEditorHelper2D(EditorHelper2D* eh2D)
		{
			mEditorHelper2D = eh2D;
		}
...
private: System::Windows::Forms::TextBox^  SpriteTabPlatformerMaxSpeedTextbox;
private: System::Windows::Forms::Label^  label15;
private: System::Windows::Forms::TextBox^  SpriteTabTopdownMaxSpeedTextbox;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SpriteTabPlatformerMaxSpeedTextbox = (gcnew System::Windows::Forms::TextBox());
			...
			this->SpriteTabTopdownMaxSpeedTextbox = (gcnew System::Windows::Forms::TextBox());
			...
			// SpritesTab
			// 
			this->SpritesTab->Controls->Add(this->SpriteTabPlatformerSpriteGroupBox);
			...
			// SpriteTabPlatformerSpriteGroupBox
			// 
			this->SpriteTabPlatformerSpriteGroupBox->Controls->Add(this->SpriteTabPlatformerMaxSpeedTextbox);
			this->SpriteTabPlatformerSpriteGroupBox->Controls->Add(this->label15);
			...
			this->SpriteTabPlatformerSpriteGroupBox->Location = System::Drawing::Point(35, 157);
			...
			// 
			// SpriteTabPlatformerMaxSpeedTextbox
			// 
			this->SpriteTabPlatformerMaxSpeedTextbox->Location = System::Drawing::Point(77, 348);
			this->SpriteTabPlatformerMaxSpeedTextbox->Name = L"SpriteTabPlatformerMaxSpeedTextbox";
			this->SpriteTabPlatformerMaxSpeedTextbox->Size = System::Drawing::Size(81, 20);
			this->SpriteTabPlatformerMaxSpeedTextbox->TabIndex = 56;
			this->SpriteTabPlatformerMaxSpeedTextbox->TextChanged += gcnew System::EventHandler(this, &ZShadeSandboxEditor2D::SpriteTabPlatformerMaxSpeedTextbox_TextChanged);
			// 
			// label15
			// 
			this->label15->AutoSize = true;
			this->label15->Location = System::Drawing::Point(15, 351);
			this->label15->Name = L"label15";
			this->label15->Size = System::Drawing::Size(61, 13);
			this->label15->TabIndex = 55;
			this->label15->Text = L"Max Speed";
			// 
			...
			// 
			this->SpriteTabPlatformerScriptBrowseButton->Location = System::Drawing::Point(240, 449);
			...
			// SpriteTabPlatformerScriptOpenButton
			// 
			this->SpriteTabPlatformerScriptOpenButton->Location = System::Drawing::Point(159, 449);
			...
			// SpriteTabPlatformerScriptTextbox
			// 
			this->SpriteTabPlatformerScriptTextbox->Location = System::Drawing::Point(53, 451);
			...
			this->label71->Location = System::Drawing::Point(11, 454);
			...
			// SpriteTabPlatformerLevelTextbox
			// 
			this->SpriteTabPlatformerLevelTextbox->Location = System::Drawing::Point(54, 427);
			...
			this->label72->Location = System::Drawing::Point(14, 430);
			...
			// SpriteTabPlatformerExperienceTextbox
			// 
			this->SpriteTabPlatformerExperienceTextbox->Location = System::Drawing::Point(80, 401);
			...
			this->label73->Location = System::Drawing::Point(14, 404);
			...
			// SpriteTabPlatformerDefenseTextbox
			// 
			this->SpriteTabPlatformerDefenseTextbox->Location = System::Drawing::Point(64, 375);
			...
			this->label74->Location = System::Drawing::Point(14, 378);
			...
			// SpriteTabTopdownSpriteGroupBox
			// 
			this->SpriteTabTopdownSpriteGroupBox->Controls->Add(this->SpriteTabTopdownMaxSpeedTextbox);
			this->SpriteTabTopdownSpriteGroupBox->Controls->Add(this->label67);
			...
			// 
			// SpriteTabTopdownMaxSpeedTextbox
			// 
			this->SpriteTabTopdownMaxSpeedTextbox->Location = System::Drawing::Point(85, 390);
			this->SpriteTabTopdownMaxSpeedTextbox->Name = L"SpriteTabTopdownMaxSpeedTextbox";
			this->SpriteTabTopdownMaxSpeedTextbox->Size = System::Drawing::Size(81, 20);
			this->SpriteTabTopdownMaxSpeedTextbox->TabIndex = 60;
			this->SpriteTabTopdownMaxSpeedTextbox->TextChanged += gcnew System::EventHandler(this, &ZShadeSandboxEditor2D::SpriteTabTopdownMaxSpeedTextbox_TextChanged);
			// 
			// label67
			// 
			this->label67->AutoSize = true;
			this->label67->Location = System::Drawing::Point(18, 396);
			this->label67->Name = L"label67";
			this->label67->Size = System::Drawing::Size(61, 13);
			this->label67->TabIndex = 59;
			this->label67->Text = L"Max Speed";
			// 
			// SpriteTabTopdownAlwaysSeenByPlayerCheckbox
			// 
			this->SpriteTabTopdownAlwaysSeenByPlayerCheckbox->AutoSize = true;
			this->SpriteTabTopdownAlwaysSeenByPlayerCheckbox->Location = System::Drawing::Point(298, 419);
			...
			// 
			this->SpriteTabTopdownScriptBrowseButton->Location = System::Drawing::Point(244, 490);
			...
			this->SpriteTabTopdownTouchCheckbox->Location = System::Drawing::Point(375, 491);
			...
			this->SpriteTabTopdownNoHitCheckbox->Location = System::Drawing::Point(375, 470);
			...
			this->SpriteTabTopdownHardCheckbox->Location = System::Drawing::Point(375, 447);
			...
			// SpriteTabTopdownScriptOpenButton
			// 
			this->SpriteTabTopdownScriptOpenButton->Location = System::Drawing::Point(163, 490);
			...
			// SpriteTabTopdownScriptTextbox
			// 
			this->SpriteTabTopdownScriptTextbox->Location = System::Drawing::Point(57, 492);
			...
			this->label63->Location = System::Drawing::Point(15, 495);
			...
			// SpriteTabTopdownLevelTextbox
			// 
			this->SpriteTabTopdownLevelTextbox->Location = System::Drawing::Point(58, 468);
			...
			this->label59->Location = System::Drawing::Point(18, 471);
			...
			// SpriteTabTopdownExperienceTextbox
			// 
			this->SpriteTabTopdownExperienceTextbox->Location = System::Drawing::Point(84, 442);
			...
			this->label58->Location = System::Drawing::Point(18, 445);
			...
			// SpriteTabTopdownDefenseTextbox
			// 
			this->SpriteTabTopdownDefenseTextbox->Location = System::Drawing::Point(68, 416);
			...
			this->label57->Location = System::Drawing::Point(18, 419);
...
#pragma endregion
	...
	private: System::Void StartTimer_Tick(System::Object^  sender, System::EventArgs^  e)
	{
		if (!bInitialized)
		{
			// If each editor window has a separate splitter container then there will have to be separate
			// DXGameWindow objects for each editor window. To use the same one then the splitter container
			// needs to be created only once and used for each editor window. When means that this code needs
			// to go somewhere where it gets called no matter what editor is clicked on first. Otherwise
			// all the editor windows need to be created at start up.
			...
			//ZShadeSandbox::Instance()->InitDXWindow(hwnd);
			
			mDXGameWindow = new DXGameWindow();
			mDXGameWindow->Init(mEngineOptions, hwnd);
			
			// Might need to make the thread global so I can start and stop it
		...
		/*if (ZShadeSandbox::Instance()->GetEditorHelper2D())
		{
	...
	bool bSpriteReposition;
	bool bSpriteResize;
	bool bSpriteNoUpdate;
	bool bSpriteGoFastUpdate;
	bool bSpriteInstantResize; // Not sure if instant can be used since a button only responds when clicked.
							   // Maybe if Button Down was set for the buttons the updating will be instant
							   // and this will not be needed.
							   // Maybe this can be used in Mouse Down function so that the sprite is only
							   // instantly resized if this the instant resize variable is true (Checked).
	
	void CheckRepositionAndResizeOfSpriteTab()
	{
		bSpriteReposition = SpriteTabRepositionRadioButton->Checked;
		bSpriteResize = SpriteTabResizeRadioButton->Checked;
		bSpriteNoUpdate = SpriteTabNoUpdateRadioButton->Checked;
		bSpriteGoFastUpdate = SpriteTabGoFastCheckbox->Checked;
		bSpriteInstantResize = SpriteTabInstantCheckbox->Checked;
	}
	...
	{
		mEditorHelper2D->GetMapEditorSystem2D()->ResizeSpriteUpdate(
			bSpriteReposition,
			bSpriteResize,
			bSpriteGoFastUpdate,
			false,

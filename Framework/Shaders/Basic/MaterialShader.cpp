...
bool MaterialShader::Initialize()
{
	...
	SetInputLayoutDesc("MaterialShader", ZShadeSandboxMesh::VertexLayout::mesh_layout_pos_normal_tex_instance_rot_scl, 6);

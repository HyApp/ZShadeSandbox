...
void ShaderCompiler::CompileAll(D3D* d3d)
{
	...
	Compile(d3d, "Basic\\Texture.hlsl", "TextureVS", EShaderTypes::ST_VERTEX);
	Compile(d3d, "Basic\\Texture.hlsl", "TexturePS", EShaderTypes::ST_PIXEL);
	...
	Compile(d3d, "BasicTessellation\\MaterialTessellationCommon.hlsl", "MaterialTessellationVS", EShaderTypes::ST_VERTEX);
	...
	Compile(d3d, "BasicTessellation\\MaterialTessellationCommon.hlsl", "MaterialTessellationPS", EShaderTypes::ST_PIXEL);
	Compile(d3d, "BasicTessellation\\MaterialTessellationCommon.hlsl", "MaterialTessellationLightPS", EShaderTypes::ST_PIXEL);
	Compile(d3d, "BasicTessellation\\MaterialTessellationCommon.hlsl", "MaterialTessellationWireframePS", EShaderTypes::ST_PIXEL);
	/*

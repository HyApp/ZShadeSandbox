...
public:
	...
	virtual void Render(int indexStart, int indexCount, ZShadeSandboxMesh::MeshRenderParameters mrp, ZShadeSandboxLighting::ShaderMaterial* material) {}
	...
	void RenderDrawInstanced11(int vertexCount, int primCount);
	...
	void RenderIndexInstanced11(int startIndex, int indexCount, int primCount);

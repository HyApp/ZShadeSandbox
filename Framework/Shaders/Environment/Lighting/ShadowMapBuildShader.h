...
public:
	...
	bool Render(int indexCount, int instanceCount, XMMATRIX world, LightCamera* lightCamera);
	bool Render(int startIndex, int indexCount, int instanceCount, XMMATRIX world, LightCamera* lightCamera);

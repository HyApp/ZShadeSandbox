...
//==============================================================================================================================
bool ShadowMapBuildShader::Render(int indexCount, int instanceCount, XMMATRIX world, LightCamera* lightCamera)
{
...
//==============================================================================================================================
bool ShadowMapBuildShader::Render(int startIndex, int indexCount, int instanceCount, XMMATRIX world, LightCamera* lightCamera)
{
	cbShadowMapConst cSMB;

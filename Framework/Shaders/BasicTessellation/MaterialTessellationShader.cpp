...
bool MaterialTessellationShader::Initialize()
{
	...
	ClearInputLayout();
	SetInputLayoutDesc("MaterialTessellationShader", ZShadeSandboxMesh::VertexLayout::mesh_layout_pos_normal_tex_instance_rot_scl, 6);
	...
	LoadPixelShader("MaterialTessellationPS");
...
)
{
	...
	if (!m_Wireframe)
	{
		...
		SwitchTo("MaterialTessellationPS", ZShadeSandboxShader::EShaderTypes::ST_PIXEL);
	}
	else
	{

...
bool MaterialLightTessellationShader::Initialize()
{
	...
	ClearInputLayout();
	SetInputLayoutDesc("MaterialTessellationLightShader", ZShadeSandboxMesh::VertexLayout::mesh_layout_pos_normal_tex_instance_rot_scl, 6);
	LoadVertexShader("MaterialTessellationVS");
	switch (mType)
	{
	...
	LoadPixelShader("MaterialTessellationLightPS");
	LoadPixelShader("MaterialTessellationWireframePS");
	AssignVertexShaderLayout("MaterialTessellationLightShader");
...
)
{
	...
	if (!m_Wireframe)
	{
		...
		SwitchTo("MaterialTessellationLightPS", ZShadeSandboxShader::EShaderTypes::ST_PIXEL);
	}
	else
	{
		SwitchTo("MaterialTessellationWireframePS", ZShadeSandboxShader::EShaderTypes::ST_PIXEL);
	}
	...
	SetInputLayout("MaterialTessellationLightShader");

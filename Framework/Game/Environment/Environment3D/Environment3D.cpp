...
//================================================================================================================
void Environment3D::SwitchD3DWindow(HWND hwnd)
{
	if (m_D3DSystem)
	{
		mEngineOptions->hwnd = hwnd;
		
		// Prepare for setting up the device with a new window
		m_D3DSystem->Shutdown();
		
		if (!m_D3DSystem->Initialize11(mEngineOptions))
		{
			MessageBox(NULL, "Direct3D Failed to register new window", "Error", MB_OK);
		}
	}
}
//===============================================================================================================================

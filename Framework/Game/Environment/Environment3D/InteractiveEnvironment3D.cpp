...
//===============================================================================================================================
//===============================================================================================================================
InteractiveEnvironment3D::InteractiveEnvironment3D(EngineOptions* eo)
:	mEngineOptions(eo)
{
	Init();
}
//===============================================================================================================================
InteractiveEnvironment3D::~InteractiveEnvironment3D()
{
	Shutdown();
}
//===============================================================================================================================
bool InteractiveEnvironment3D::Init()
{
	mPickingSphere = NULL;
	iTriangleCount = 0;
	fTessFactor = 6.0f;
	...
	// Initialize the deferred shader manager that handles all the lights in the deferred shader in the scene
...
//===============================================================================================================================
void InteractiveEnvironment3D::Shutdown()
{
	m_D3DSystem->Shutdown();
}
//===============================================================================================================================
bool InteractiveEnvironment3D::Quickwire()
{
	// LeftAlt or Space
...
//==============================================================================================================================
void InteractiveEnvironment3D::UpdateMaster()
{
...
//===============================================================================================================================
void InteractiveEnvironment3D::RenderMaster()
{
...
//===============================================================================================================================
void InteractiveEnvironment3D::RenderSky(bool reflections)
{
	if (!bToggleSky)
		return;
...
//===============================================================================================================================
void InteractiveEnvironment3D::RenderSpawnedMeshItems(ZShadeSandboxMesh::MeshRenderParameters mrp)
{
...
//===============================================================================================================================
void InteractiveEnvironment3D::UpdateSpawnedMeshItems(float dt)
{
	vector<ZShadeSandboxMesh::CustomMesh*>::iterator it = m_SpawnedMeshContainer.begin();
	for (; it != m_SpawnedMeshContainer.end(); it++)
	{
...
//===============================================================================================================================
void InteractiveEnvironment3D::ToggleSpawnedMeshItemsWireframe(bool wireframe)
{
	vector<ZShadeSandboxMesh::CustomMesh*>::iterator it = m_SpawnedMeshContainer.begin();
	for (; it != m_SpawnedMeshContainer.end(); it++)
	{
...
//===============================================================================================================================
void InteractiveEnvironment3D::RenderLightMesh(ZShadeSandboxMesh::MeshRenderParameters mrp)
{
...
//===============================================================================================================================
void InteractiveEnvironment3D::ToggleLightMeshWireframe(bool wireframe)
{
	if (bEnableDeferredShading)
	{
...
//===============================================================================================================================
void InteractiveEnvironment3D::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
//===============================================================================================================================
void InteractiveEnvironment3D::OnMouseUp(WPARAM btnState, int x, int y)
{
	if ((btnState & MK_LBUTTON) != 0)
	{
		bLeftMouseDown = false;
...
//===============================================================================================================================
void InteractiveEnvironment3D::OnMouseMove(WPARAM btnState, int x, int y)
{
...
//===============================================================================================================================
void InteractiveEnvironment3D::RenderRefractionToTexture()
{
...
//===============================================================================================================================
void InteractiveEnvironment3D::RenderReflectionToTexture()
{
	//Use the camera to render the reflection and craete a reflection view matrix
	//Get the camera reflection view matrix instead of the normal view matrix
	m_CameraSystem->UpdateReflection(fSeaLevel);
...
//===============================================================================================================================
void InteractiveEnvironment3D::RenderShadowMapToTexture()
{
...
//===============================================================================================================================
int InteractiveEnvironment3D::Run()
{
	UpdateMaster();

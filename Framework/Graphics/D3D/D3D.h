...
public:
	...
	bool InitializeAdapterAndModes11();
	bool InitializeDeviceAndSwapChain11();
	bool InitializeBackbuffers11();
	
	bool Initialize12(EngineOptions* options);
	bool InitializeAdapterAndModes12();
	bool InitializeDeviceAndSwapChain12();
	bool InitializeBackbuffers12();
	bool InitializeCommandListAndFence12();
...
private:
	...
	ID3D12Resource* m_backBufferRTV[2];
	...
	*/
	...
	//
	// Screen and device info for DX11 and DX12
	//

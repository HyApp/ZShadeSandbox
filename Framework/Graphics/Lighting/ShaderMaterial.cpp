...
void ShaderMaterial::BuildMaterialConstantBuffer(ID3D11Buffer*& buffer, XMFLOAT3 eye, XMFLOAT4 clipplane)
{
	...
	cMSB.matpadding = XMFLOAT2(0, 0);
	cMSB.g_UsingInstancing = (bUsingInstancing) ? 1 : 0;
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::DiffuseArrayTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
		{
			case ZShadeSandboxLighting::EMaterialTextureType::eDiffuseArray:
				return GetTexture(i)->getTexture11();
			break;
		}
	}
}
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::DiffuseTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::AmbientTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::SpecularTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::EmissiveTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::NormalMapTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::BlendMapTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::DetailMapTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::AlphaMapTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::ShadowMapTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::SSAOMapTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))
...
//==============================================================================================================================
ID3D11ShaderResourceView* ShaderMaterial::DisplacementMapTexture()
{
	for (int i = 0; i < mMaterialTextures.size(); i++)
	{
		switch (GetMaterialTextureType(i))

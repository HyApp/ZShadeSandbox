...
public:
	...
	// Updates the heightmap with new values radiating from an origin point by creating a radial gradient
	...
	void DistortMap(short waveLength, int amplitude);
	void SlopeMap();
	void FloodMap(float water);

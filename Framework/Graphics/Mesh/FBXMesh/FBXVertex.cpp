...
bool ZShadeSandboxMesh::VertexNormalTexBlend::operator == (const ZShadeSandboxMesh::VertexNormalTexBlend& rhs) const
{
	...
	bool result4 = ZShadeSandboxMath::ZMath::CompareVector3WithEpsilon(tangent, rhs.tangent);
	
	return result1 && result2 && result3 && result4 && sameBlendingInfo;
}
//==============================================================================================================================
bool ZShadeSandboxMesh::VertexNormalTexBlend::EqualsPos(const VertexNormalTexBlend& rhs)
{
	return ZShadeSandboxMath::ZMath::CompareVector3WithEpsilon(position, rhs.position);
}
//==============================================================================================================================
bool ZShadeSandboxMesh::VertexNormalTexBlend::EqualsPosNorm(const VertexNormalTexBlend& rhs)
{
	bool result1 = ZShadeSandboxMath::ZMath::CompareVector3WithEpsilon(position, rhs.position);
	bool result2 = ZShadeSandboxMath::ZMath::CompareVector3WithEpsilon(normal, rhs.normal);
...
//==============================================================================================================================
bool ZShadeSandboxMesh::VertexNormalTexBlend::EqualsPosNormTex(const VertexNormalTexBlend& rhs)
{
	bool result1 = ZShadeSandboxMath::ZMath::CompareVector3WithEpsilon(position, rhs.position);
	bool result2 = ZShadeSandboxMath::ZMath::CompareVector3WithEpsilon(normal, rhs.normal);
	bool result3 = ZShadeSandboxMath::ZMath::CompareVector2WithEpsilon(texture, rhs.texture);
...
//==============================================================================================================================
bool ZShadeSandboxMesh::VertexNormalTexBlend::EqualsPosNormTexTan(const VertexNormalTexBlend& rhs)
{
	bool result1 = ZShadeSandboxMath::ZMath::CompareVector3WithEpsilon(position, rhs.position);
	bool result2 = ZShadeSandboxMath::ZMath::CompareVector3WithEpsilon(normal, rhs.normal);
	bool result3 = ZShadeSandboxMath::ZMath::CompareVector2WithEpsilon(texture, rhs.texture);

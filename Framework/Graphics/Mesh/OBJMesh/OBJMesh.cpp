...
//===============================================================================================================================
void OBJMesh::AddInstanceMatrix(vector<ZShadeSandboxMesh::InstanceMatrix> instMat)
{
	m_pMesh->AddInstanceMatrix(instMat);
}
//===============================================================================================================================
void OBJMesh::Mesh::AddInstanceMatrix(vector<ZShadeSandboxMesh::InstanceMatrix> instMat)
{
	mAttributes->AddInstanceMatrix(instMat);
}
//===============================================================================================================================
MeshAttributes*& OBJMesh::Attributes()
{
	return m_pMesh->Attributes();
}
//===============================================================================================================================
MeshAttributes* OBJMesh::Attributes() const
{
	return m_pMesh->Attributes();
}
//===============================================================================================================================
vector<ZShadeSandboxMesh::InstanceMatrix>& OBJMesh::InstanceMatrices()
{
	return m_pMesh->InstanceMatrices();
}
//===============================================================================================================================
vector<ZShadeSandboxMesh::InstanceMatrix>& OBJMesh::Mesh::InstanceMatrices()
{
	return mAttributes->mInstanceMatrix;
}
//===============================================================================================================================
vector<ZShadeSandboxMesh::InstanceMatrix> OBJMesh::InstanceMatrices() const
{
	return m_pMesh->InstanceMatrices();
}
//===============================================================================================================================
vector<ZShadeSandboxMesh::InstanceMatrix> OBJMesh::Mesh::InstanceMatrices() const
{
	return mAttributes->mInstanceMatrix;
}
//===============================================================================================================================
/*void OBJMesh::AddCustomShader(Shader* shader)
{
	m_pMesh->AddCustomShader(shader);
}
//===============================================================================================================================
void OBJMesh::AddCustomTessellationShader(Shader* shader)
{
	m_pMesh->AddCustomTessellationShader(shader);
}
//===============================================================================================================================
void OBJMesh::AddCustomOBJGBufferShader(Shader* shader)
{
	m_pMesh->AddCustomOBJGBufferShader(shader);
}*/
//===============================================================================================================================
bool& OBJMesh::HasCustomShader()
{
	return m_pMesh->HasCustomShader();
}
//===============================================================================================================================
bool OBJMesh::HasCustomShader() const
{
	return m_pMesh->HasCustomShader();
}
//===============================================================================================================================
ZShadeSandboxShader::Shader*& OBJMesh::CustomShader()
{
	return m_pMesh->CustomShader();
}
//===============================================================================================================================
ZShadeSandboxShader::Shader* OBJMesh::CustomShader() const
{
	return m_pMesh->CustomShader();
}
//===============================================================================================================================
ZShadeSandboxShader::Shader*& OBJMesh::CustomTessellationShader()
{
	return m_pMesh->CustomTessellationShader();
}
//===============================================================================================================================
ZShadeSandboxShader::Shader* OBJMesh::CustomTessellationShader() const
{
	return m_pMesh->CustomTessellationShader();
}
//===============================================================================================================================
ZShadeSandboxShader::Shader*& OBJMesh::CustomOBJGBufferShader()
{
	return m_pMesh->CustomOBJGBufferShader();
}
//===============================================================================================================================
ZShadeSandboxShader::Shader* OBJMesh::CustomOBJGBufferShader() const
{
	return m_pMesh->CustomOBJGBufferShader();
}
//===============================================================================================================================
//void OBJMesh::Mesh::AddCustomShader(Shader* shader)
//{
//	mCustomShader = shader;
//	bHasCustomShader = true;
//}
//===============================================================================================================================
ZShadeSandboxShader::Shader*& OBJMesh::Mesh::CustomShader()
{
	return mCustomShader;
}
//===============================================================================================================================
ZShadeSandboxShader::Shader* OBJMesh::Mesh::CustomShader() const
{
	return mCustomShader;
}
//===============================================================================================================================
ZShadeSandboxShader::Shader*& OBJMesh::Mesh::CustomTessellationShader()
{
	return mCustomTessellationShader;
}
//===============================================================================================================================
ZShadeSandboxShader::Shader* OBJMesh::Mesh::CustomTessellationShader() const
{
	return mCustomTessellationShader;
}
//===============================================================================================================================
ZShadeSandboxShader::Shader*& OBJMesh::Mesh::CustomOBJGBufferShader()
{
	return mCustomOBJGBufferShader;
}
//===============================================================================================================================
ZShadeSandboxShader::Shader* OBJMesh::Mesh::CustomOBJGBufferShader() const
{
	return mCustomOBJGBufferShader;
}
//===============================================================================================================================
...
{
	if (m_pMesh->HasCustomShader())
		m_pMesh->RenderCustom(render_param);
	else
...
//}
void OBJMesh::Mesh::AddInstanceMatrix
(	vector<XMFLOAT3> instancePositions
,	vector<XMFLOAT3> instanceRotations
,	vector<XMFLOAT3> instanceScales
)
{
	mAttributes->AddInstanceMatrix(
		instancePositions,
		instanceRotations,
		instanceScales
	);
	...
	: mD3DSystem(d3d)
{
	...
	mCustomShader = 0;
	mCustomTessellationShader = 0;
	mCustomOBJGBufferShader = 0;
...
{
	if (bHasCustomShader) return;
	if (render_param.camera == NULL || !render_param.toggleMesh) return;
	
	if (!render_param.specifyWorld) render_param.world = mAttributes->WorldXM();
	
	if (render_param.useInstancing)
	{
		mAttributes->SetBuffersInstanced(render_param.renderType);
		//render_param.world = XMMatrixIdentity();
	}
	else
	{
	...
	if (render_param.reflection)
		render_param.view = render_param.camera->ReflectionView4x4();
	else
		render_param.view = render_param.camera->View4x4();
	...
	for (auto& group : mGroups)
	{
		...
		else
		{
			if (render_param.tessellate)
			{
				...
				material->bEnableDistTess = render_param.enableDistTess;
				material->fMinTessDist = render_param.minTessDist;
				material->fMaxTessDist = render_param.maxTessDist;
				material->fMinTessFactor = render_param.minTess;
				material->fMaxTessFactor = render_param.maxTess;
				material->fNoDistTessFactor = render_param.noDistTessFactor;
				
				switch (render_param.renderType)
				{
					case ZShadeSandboxMesh::ERenderType::e3ControlPointPatchList:
					{
						if (render_param.renderLight)
						{
					...
					default:
					{
						...
						ZShadeMessageCenter::MsgBoxError(NULL, "OBJMesh: Tessellation Shader was not defined !!!");
					}
					break;
				}
			}
...
//===============================================================================================================================
void OBJMesh::Mesh::RenderCustom(MeshRenderParameters render_param)
{
	if (!bHasCustomShader) return;
	if (render_param.camera == NULL || !render_param.toggleMesh) return;
	...
	for (auto& group : mGroups)
	{
		...
		if (render_param.renderDeferred)
		{
			mCustomOBJGBufferShader->Render(
				group.IndexStart,
				group.IndexCount,
				render_param,
				material
		...
		else
		{
			if (render_param.tessellate)
			{
				mCustomTessellationShader->Render(
					group.IndexStart,
					group.IndexCount,
					render_param,
					material

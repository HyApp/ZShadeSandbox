...
public:
	...
	// Writes a texture on the fly
	void WriteToFile(BetterString filename, ID3D11Texture2D* texture);
...
private:
	...
	void WriteDDSToFile(LPCWSTR filename, ID3D11Texture2D* texture);
	void WriteTGAToFile(LPCWSTR filename, ID3D11Texture2D* texture);
	void WritePNGToFile(LPCWSTR filename, ID3D11Texture2D* texture);

...
//===============================================================================================================================
void TextureManager::WriteToFile(BetterString filename, ID3D11Texture2D* texture)
{
	string fileExt = CGlobal::GetFileExt(filename);
	...
	{
		unique_ptr<wchar_t> name = filename.ToWideStr();
		WriteDDSToFile(name.get(), texture);
	}
	else if (fileExt == "tga")
	{
		unique_ptr<wchar_t> name = filename.ToWideStr();
		WriteTGAToFile(name.get(), texture);
	}
	else if (fileExt == "png")
	{
		unique_ptr<wchar_t> name = filename.ToWideStr();
		WritePNGToFile(name.get(), texture);
	}
}
//===============================================================================================================================
...
//===============================================================================================================================
void TextureManager::WriteDDSToFile(LPCWSTR filename, ID3D11Texture2D* texture)
{
	HRESULT result;
	result = SaveDDSTextureToFile(mD3DSystem->GetDeviceContext(), texture, filename);
	
	if (FAILED(result))
	{
		ScratchImage image;
		result = CaptureTexture(mD3DSystem->GetDevice11(), mD3DSystem->GetDeviceContext(), texture, image);
...
//===============================================================================================================================
void TextureManager::WriteTGAToFile(LPCWSTR filename, ID3D11Texture2D* texture)
{
	HRESULT result;
	ScratchImage image;
	result = CaptureTexture(mD3DSystem->GetDevice11(), mD3DSystem->GetDeviceContext(), texture, image);
...
//===============================================================================================================================
void TextureManager::WritePNGToFile(LPCWSTR filename, ID3D11Texture2D* texture)
{
	HRESULT result;
	result = SaveWICTextureToFile(mD3DSystem->GetDeviceContext(), texture, GUID_ContainerFormatPng, filename);
